...
```{r}
# tte/tte
T_1_1=cbind(gener_tte(1.5),gener_tte(1))
C_1_1=cbind(gener_tte(0.5),gener_tte(0.33))

# tte/continue
T_1_2=cbind(gener_tte(1.5),gener_continue(2,0))
C_1_2=cbind(gener_tte(0.33),gener_continue(0,1))

# tte/binaire
T_1_3=cbind(gener_tte(1),gener_binom(0.45))
C_1_3=cbind(gener_tte(0.33),gener_binom(0.75))

# continue/continue
T_1_4=cbind(gener_continue(3,0),gener_continue(2,1))
