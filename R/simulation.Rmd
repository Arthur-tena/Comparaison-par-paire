...
stratum=sample(rep(c(1,3,5,8), each = 50))
dataT=data.frame(Y_1 = Time_T[1:n], Delta_1 = deltaT[1:n], Y_2 = Y_2_T, Y_3 = Y_3_T, stratum = stratum)
dataC=data.frame(Y_1 = Time_T[n+1:2*n], Delta_1 = deltaT[n+1:2*n], Y_2 = Y_2_C, Y_3 = Y_3_C, stratum = stratum)
...
ggsave("Rplot3_20", device = "pdf", path = "../plots")
