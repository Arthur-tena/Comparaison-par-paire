...
fup_censure1=round(rweibull(2*n, shape = 2, scale =20),3)
fup_censure2=round(rweibull(2*n, shape = 2, scale =20),3)
...
Time_1 = pmin(Time1, t, fup_censure1)
# summary(Time_1)
# summary(Time_1[Z==1])
#  summary(Time_1[Z==0])
...
Time_2 = pmin(Time2, t, fup_censure2)
# summary(Time_2)
# summary(Time_2[Z==1])
#  summary(Time_2[Z==0])
