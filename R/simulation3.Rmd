...
fup_censure1=round(rexp(2*n, rate = 0.03),3)
summary(fup_censure1)
fup_censure2=round(rexp(2*n, rate = 0.03),3)
...
delta1 = as.numeric(Time_1==Time1)
...
delta2 = as.numeric(Time_2==Time2)
...
summ_val3_1=summary(val)
 ...
 summary.data.frame(values_long)
...
#ggsave("Cox_t9.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
```
...
#ggsave("Cox_t14.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#ggsave("Cox_t19.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
fup_censure1=round(rexp(2*n, rate = 0.08),3)
fup_censure2=round(rexp(2*n, rate = 0.08),3)
summary(fup_censure2)


mu1 <- 2; sigma1 <- 1.2
mu2 <- 1.5; sigma2 <- 0.8

Time1 = round(exp(mu1 + sigma1 * qnorm(U1)) * exp(Z * beta), 3)
summary(Time1)
Time_1 = pmin(Time1,  fup_censure1)
delta1 = as.numeric(Time_1==Time1)

Time2 = round(exp(mu2 + sigma2 * qnorm(U2)) * exp(Z * beta), 3)
summary(Time2)
Time_2 = pmin(Time2,  fup_censure2)
delta2 = as.numeric(Time_2==Time2)

surv_object_1 <- Surv(time = Time_1, event = delta1)


surv_object_2 <- Surv(time = Time_2, event = delta2)

km_fit_1 <- survfit(surv_object_1 ~ arm)

km_fit_2 <- survfit(surv_object_2 ~ arm)

plot(km_fit_1, col = c("blue", "red"), lwd = 2, 
     xlab = "Temps", ylab = "Probabilité de survie", main = "Courbe de survie Kaplan-Meier - Time1")
legend("bottomleft", legend = c("C", "T"), col = c("blue", "red"), lwd = 2)


plot(km_fit_2, col = c("blue", "red"), lwd = 2,
     xlab = "Temps", ylab = "Probabilité de survie", main = "Courbe de survie Kaplan-Meier - Time2")
...
#      xlab = "Temps", ylab = "Probabilité de survie", main = "Courbe de survie Kaplan-Meier - Time1")
# legend("bottomleft", legend = c("C", "T"), col = c("blue", "red"), lwd = 2)
# #ggsave("KM_survie1.pdf", device = "pdf")
# 
# plot(km_fit_2, col = c("blue", "red"), lwd = 2,
#      xlab = "Temps", ylab = "Probabilité de survie", main = "Courbe de survie Kaplan-Meier - Time2")
# #ggsave("KM_survie2.pdf")
# legend("bottomleft", legend = c("C", "T"), col = c("blue", "red"), lwd = 2)
...
ggplot(values_long, aes(x = value, fill = method)) +
   ...
   scale_linetype_manual(name = "", values = c("Hypothèse H0" = "dashed")) +
   scale_fill_manual(values = c("orange",  "purple", "cyan")) +
  annotate("text", x = 8.5, y = 3.1, label = paste("Étendue GPC : ", étendue_GPC), color = "orange", hjust = 1) +
  annotate("text", x = 8.5, y = 4, label = paste("Étendue WR : ", étendue_WR), color = "cyan", hjust = 1) +
  annotate("text", x = 8.5, y = 4.9, label = paste("Étendue WO : ", étendue_WO), color = "purple", hjust = 1) 

ggsave("AFT_t9.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#    scale_linetype_manual(name = "", values = c("Hypothèse H0" = "dashed")) +
#    scale_fill_manual(values = c("orange",  "purple", "cyan")) +
#   annotate("text", x = 8.5, y = 1.6, label = paste("Étendue GPC : ", étendue_GPC), color = "orange", hjust = 1) +
#   annotate("text", x = 8.5, y = 2.35, label = paste("Étendue WR : ", étendue_WR), color = "cyan", hjust = 1) +
#   annotate("text", x = 8.5, y = 3.1, label = paste("Étendue WO : ", étendue_WO), color = "purple", hjust = 1)
# 
# ggsave("AFT_t14.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#    scale_linetype_manual(name = "", values = c("Hypothèse H0" = "dashed")) +
#    scale_fill_manual(values = c("orange",  "purple", "cyan")) +
#   annotate("text", x = 5.5, y = 1.6, label = paste("Étendue GPC : ", étendue_GPC), color = "orange", hjust = 1) +
#   annotate("text", x = 5.5, y = 2.35, label = paste("Étendue WR : ", étendue_WR), color = "cyan", hjust = 1) +
#   annotate("text", x = 5.5, y = 3.1, label = paste("Étendue WO : ", étendue_WO), color = "purple", hjust = 1)
# 
# ggsave("AFT_t19.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#ggsave("stat_plot_Cox_WR.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#ggsave("stat_plot_Cox_WO.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
#ggsave("stat_plot_Cox_NB.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
```
...
stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "WR", stratum.weight = "equal", plot_CI = TRUE, plotTimeUnit = "months") + coord_cartesian(ylim = c(0, 7))

#ggsave("stat_plot_AFT_WR.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )


stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "WO", stratum.weight = "equal", plot_CI = TRUE, plotTimeUnit = "months") + coord_cartesian(ylim = c(0, 7))
# ggsave("stat_plot_AFT_WO.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
# stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "NB", stratum.weight = "equal", plot_CI = TRUE, plotTimeUnit = "months")
# ggsave("stat_plot_AFT_NB.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
```
