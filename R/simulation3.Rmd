...
results_df5 = as.data.frame(do.call(rbind, df_5))
results_df7 = as.data.frame(do.call(rbind, df_7))

colnames(results_df2) = col_names
colnames(results_df5) = col_names
colnames(results_df7) = col_names
...
min_Y_1C=mean(as.numeric(results_df2[,10]))
...
min_Y_2T=mean(as.numeric(results_df2[,17]))
...
list(Count = df3, value_tte_cont_C = dfC, value_tte_cont_T = dfT, value_binary = df2, censure = df4, p_val_GPC = paste("probabilité d'avoir des p-valeur < 0.05 pour la GPC: ", nb_pval_GPC/n_sim), p_val_WR =  paste("probabilité d'avoir des p-valeur < 0.05 pour le WR: ", nb_pval_WR/n_sim), p_val_WO = paste("probabilité d'avoir des p-valeur < 0.05 pour le WO: ", nb_pval_WO/n_sim))
...
val1=unlist(results_df2[,1:3]$V1)
val2=unlist(results_df2[,1:3]$V2)
val3=unlist(results_df2[,1:3]$V3)
val=as.data.frame(unname(cbind(val1,val2,val3)))
colnames(val)=c("val_GPC","val_WR","val_WO")
...
```{r}
GPC=as.numeric(results_df5[,1])
WR= as.numeric(results_df5[,2])
WO= as.numeric(results_df5[,3])

Win   = round(c(mean(as.numeric(results_df5[,4])), mean(as.numeric(results_df5[,7])), mean(as.numeric(results_df5[,4])) + mean(as.numeric(results_df5[,7]))  ))

Loose = round(c(mean(as.numeric(results_df5[,5])), mean(as.numeric(results_df5[,8])), mean(as.numeric(results_df5[,5]))+mean(as.numeric(results_df5[,8]))  ))

Tie   = round(c(mean(as.numeric(results_df5[,6])), mean(as.numeric(results_df5[,9])), mean(as.numeric(results_df5[,9])) ))


min_Y_1C=mean(as.numeric(results_df5[,10]))
min_Y_2C=mean(as.numeric(results_df5[,11]))

max_Y_1C=mean(as.numeric(results_df5[,12]))
max_Y_2C=mean(as.numeric(results_df5[,13]))

median_Y_1C=mean(as.numeric(results_df5[,14]))
median_Y_2C=mean(as.numeric(results_df5[,15]))

min_Y_1T=mean(as.numeric(results_df5[,16]))
min_Y_2T=mean(as.numeric(results_df5[,17]))

max_Y_1T=mean(as.numeric(results_df5[,18]))
max_Y_2T=mean(as.numeric(results_df5[,19]))

median_Y_1T=mean(as.numeric(results_df5[,20]))
median_Y_2T=mean(as.numeric(results_df5[,21]))


censure_rateC1= mean(as.numeric(results_df5[,22]))
censure_rateT1= mean(as.numeric(results_df5[,23]))

censure_rateC2= mean(as.numeric(results_df5[,24]))
censure_rateT2= mean(as.numeric(results_df5[,25]))
...
p_valGPC = results_df5[,26]
p_valWR = results_df5[,27]
p_valWO = results_df5[,28]
...
val1=unlist(results_df5$val_GPC)
val2=unlist(results_df5$val_WR)
val3=unlist(results_df5$val_WO)
val=as.data.frame(unname(cbind(val1,val2,val3)))
colnames(val)=c("val_GPC","val_WR","val_WO")
summ_val3_1=summary(val)
...
```{r}
GPC=as.numeric(results_df7[,1])
WR= as.numeric(results_df7[,2])
WO= as.numeric(results_df7[,3])

Win   = round(c(mean(as.numeric(results_df7[,4])), mean(as.numeric(results_df7[,7])), mean(as.numeric(results_df7[,4])) + mean(as.numeric(results_df7[,7]))  ))

Loose = round(c(mean(as.numeric(results_df7[,5])), mean(as.numeric(results_df7[,8])), mean(as.numeric(results_df7[,5]))+mean(as.numeric(results_df7[,8]))  ))

Tie   = round(c(mean(as.numeric(results_df7[,6])), mean(as.numeric(results_df7[,9])), mean(as.numeric(results_df7[,9])) ))


min_Y_1C=mean(as.numeric(results_df7[,10]))
min_Y_2C=mean(as.numeric(results_df7[,11]))

max_Y_1C=mean(as.numeric(results_df7[,12]))
max_Y_2C=mean(as.numeric(results_df7[,13]))

median_Y_1C=mean(as.numeric(results_df7[,14]))
median_Y_2C=mean(as.numeric(results_df7[,15]))

min_Y_1T=mean(as.numeric(results_df7[,16]))
min_Y_2T=mean(as.numeric(results_df7[,17]))

max_Y_1T=mean(as.numeric(results_df7[,18]))
max_Y_2T=mean(as.numeric(results_df7[,19]))

median_Y_1T=mean(as.numeric(results_df7[,20]))
median_Y_2T=mean(as.numeric(results_df7[,21]))


censure_rateC1= mean(as.numeric(results_df7[,22]))
censure_rateT1= mean(as.numeric(results_df7[,23]))

censure_rateC2= mean(as.numeric(results_df7[,24]))
censure_rateT2= mean(as.numeric(results_df7[,25]))
...
p_valGPC = results_df7[,26]
p_valWR = results_df7[,27]
p_valWO = results_df7[,28]
...
val1=unlist(results_df7[,1:3]$V1)
val2=unlist(results_df7[,1:3]$V2)
val3=unlist(results_df7[,1:3]$V3)
val=as.data.frame(unname(cbind(val1,val2,val3)))
colnames(val)=c("val_GPC","val_WR","val_WO")
summ_val3_1=summary(val)
