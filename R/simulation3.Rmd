...
legend("topright", legend = c("C", "T"), col = c("blue", "red"), lwd = 2)
...
dataT=data.frame(Y_1 = Time_12[Z==1], Delta_1 = delta12[Z==1], Y_2 = Time_22[Z==1], Delta_2  = delta22[Z==1])
dataC=data.frame(Y_1 = Time_12[Z==0], Delta_1 = delta12[Z==0], Y_2 = Time_22[Z==0], Delta_2 = delta22[Z==0])
...
data=data.frame(id=id, arm = arm, Y_1= data1[,1],Delta_1=data1[,2], Y_2 = data1[,3], Y_3 = data1[,4] )
...
ggplot(values_long, aes(x = value, fill = method)) +
   ...
   scale_linetype_manual(name = "", values = c("Hypothèse H0" = "dashed")) +
   scale_fill_manual(values = c("orange",  "purple", "cyan")) 
ggsave("AFT_t14_diapo.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
ggplot(values_long, aes(x = value, fill = method)) +
   ...
   scale_linetype_manual(name = "", values = c("Hypothèse H0" = "dashed")) +
   scale_fill_manual(values = c("orange",  "purple", "cyan")) 
ggsave("AFT_t19_diapo.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
...
dataT=data.frame(Y_1 = Time_1[Z==1], Delta_1 = delta1[Z==1], Y_2 = Time_2[Z==1], Delta_2  = delta2[Z==1])
dataC=data.frame(Y_1 = Time_1[Z==0], Delta_1 = delta1[Z==0], Y_2 = Time_2[Z==0], Delta_2 = delta2[Z==0])

 
data1=rbind(dataT,dataC)

data=data.frame(id=id, arm = arm, Y_1= data1[,1],Delta_1=data1[,2], Y_2 = data1[,3], Delta_2 = data1[,4])

# partition_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0))

stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "WR", stratum.weight = "unstratified", plot_CI = TRUE, plotTimeUnit = "months")

#ggsave("stat_plot_AFT_WR.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )


stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "WO", stratum.weight = "unstratified", plot_CI = TRUE, plotTimeUnit = "months") 
# ggsave("stat_plot_AFT_WO.pdf", device = "pdf", path = "C:/Users/MASTERS TEMA Arthur/Documents/Comparaison-par-paire/plots" )
 stat_t.plot(data = data, Ctime = 1:20, arm.name = c("T", "C"), priority = c(1,2),tau = c(0,0), statistic = "NB", stratum.weight = "unstratified", plot_CI = TRUE, plotTimeUnit = "months")
